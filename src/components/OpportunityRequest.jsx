...
const OpportunityRequest = ({post, interests}) => {
        ...
        buttons: [
          {
            label: 'Yes',
            onClick: async () => {
                const reviewedRef = doc(getFirestore(), "opportunities", `${post.docId}`);
                ...
                navigate('../Opportunities-Requests')
            }
          },
          {
            label: 'No',
        ...
        buttons: [
          {
            label: 'Yes',
            onClick: async () => {
                 await deleteDoc(doc(getFirestore(), "opportunities", `${post.docId}`));
                 navigate('../category/Opportunities-Requests')
            }
          },
          {
            label: 'No',
