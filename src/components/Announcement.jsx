...
import HeartReactAnnouncement from './HeartReactAnnouncement'
...
const Announcement = ({post}) => {
  ...
  const getUserDetails = async () => {
        ...
        const docRef = doc(getFirestore(), "admins", `${postedBy}`);
  ...
  return (        
        ...
        <div className='flex h-auto w-auto pt-3 place-content-end px-2'>
                    <div className='cursor-pointer '>
                        <Link to={`/announcement-details/${post.docId}`}>
        ...
        <Link to={'?'}>
            <div className='flex flex-cols-3 pt-3 pl-0 w-auto'>
                ...
                <div className='flex flex-col pl-2 w-4/5'>
                    ...
                    <p className='font-thin text-sm'>{createdAt} - {course}</p>
                </div>
        ...
        <div className='pt-2 grid grid-cols-3 items-center justify-center'>
            <HeartReactAnnouncement totalHearts={totalHearts} postId={post.docId} postTags={tags}/>
