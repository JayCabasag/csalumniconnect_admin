...
const AllChat = () => {
  ...
  return (
    <div className='bg-white h-auto'>
        ...
        <div className='w-full bg-white text-slate-500 font-bold flex items-center p-2 shadow-sm rounded-sm'> <FaArrowLeft className='mr-2 cursor-pointer' onClick={() => navigate('/')}/> <p>All Chat</p> </div>
